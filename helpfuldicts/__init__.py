...
class NonelessDict(collections.MutableMapping):
    """
    A wrapper around dictionaries that will check if a value is None/empty/False,
...
class NonelessOrderedDict(NonelessDict):
    """
    A NonelessDict subclass that maintains key order
    """
